...
|------|---|---|---|---|---|---|
| **XS** | 80 | 62 | 86 | 36 | 58 | 95 |
| **S** | 84 | 66 | 90 | 37 | 59 | 97 |
| **M** ←参考 | 88 | 70 | 94 | 38 | 60 | 99 |
| **L** | 92 | 74 | 98 | 39 | 61 | 101 |
| **XL** | 96 | 78 | 102 | 40 | 62 | 103 |
| **XXL** | 100 | 82 | 106 | 41 | 63 | 105 |
| **XXXL** | 104 | 86 | 110 | 42 | 64 | 107 |
...
| 项目 / Item | 数值 / Value |
|------|------|
| 总用量 Total length | 3.61 米 / m |
| 面料幅宽 Fabric width | 140 cm |
| 裁片数量 Pattern pieces | 6 片 / pcs |
| 排料效率 Marker efficiency | 68% |
| 总面积 Total area | 50552 cm² |

## 成本核算 / Cost breakdown（参考 M 码 / for size M）

| 项目 / Item | 金额 / Amount (CNY) | 说明 / Basis |
|------|-----------|------|
| 面料 Fabric | ¥433.20 | ¥120/米 × 3.61 米 |
| 辅料 Notions | ¥20.00 | 拉链/纽扣/织唛/吊牌 zipper, buttons, labels |
| 人工 Labour | ¥150.00 | 5.0 小时 h × ¥30/小时 h |
| 管理费 Overhead | ¥90.48 | 直接成本的 15% / 15% of direct cost |
| **合计 Total** | **¥693.68** | 单件出厂成本，不含利润与物流 / ex-works, excl. margin & freight |
