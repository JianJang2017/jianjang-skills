...
### v1.3.0 (2026-07-20)
- ✨ **集成 TaskList 工作流管理系统**
- 📊 配图流程 8 步可视化（分析→方案→风格→大纲→提示词→生成→插入→总结）
- 📊 发布流程 5 步可视化（确认→参数→凭证→执行→结果）
- 🔄 支持错误恢复和断点重试
- 📚 新增 `SKILL_WORKFLOW.md` 工作流规范文档
- 📚 新增 `TASKLIST_GUIDE.md` 使用指南
- 🎯 完整创作流程支持（创作 + 配图 + 发布）
...
- **SKILL_WORKFLOW.md**：🆕 TaskList 工作流规范（何时使用、如何创建任务、状态管理）
- **TASKLIST_GUIDE.md**：🆕 TaskList 使用指南（示例对话、错误处理、FAQ）
- **references/compliance.md**：版权合规详细指南
- **references/illustration-guide.md**：配图视觉风格和提示词模板
- **evals/test-article.md**：示例文章
