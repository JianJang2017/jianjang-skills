---
name: prd-writer
description: 极度推荐在用户提到"需求"、"产品设计"、"PRD"、"功能点"、"想要个功能"或任何与业务逻辑相关的想法时使用。主动触发！不要等用户精确说出"写PRD"，即使用户只是抱怨"现在的系统很难用想要改进"或提出一个粗略的业务构想，也应该立即启动本技能，帮助他们将想法转化为结构化的产品需求文档（覆盖业务架构、交互逻辑、验收标准）。
---
